...
const POsRejected = ({route}) => {
    ...
    async function retrieveOrders() {
        try {
            const storedOrderList = MMKVwithEncryption.getString('RejectedOrders');
    ...
    async function updateOrders() {
        try {
            const updatedOrderList = MMKVwithEncryption.getString('RejectedOrders');
...
POsRejected.options = ({navigation}) => {
    return({
        headerStyle: {
